...
load('sizekdes_params');
kdes_params.kdes = sizekdes_params;
...
data_params.savedir = ['../kdesfeatures/rgbd' 'sizekdes'];
...
if instance
   ...
   save('./results/pcloud_sizekdes_acc_i.mat', 'acc_i', 'predictlabel', 'testlabel');
