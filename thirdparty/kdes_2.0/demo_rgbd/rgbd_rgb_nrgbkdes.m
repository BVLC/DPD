...
data_params.savedir = ['../kdesfeatures/rgbd' 'nrgbkdes'];
...
if featag
   ...
   save -v7.3 rgbdfea_rgb_nrgbkdes rgbdfea rgbdclabel rgbdilabel rgbdvlabel;
else
   load rgbdfea_rgb_nrgbkdes;
end
...
if category
   ...
   for i = 1:trail
       ...
       save('./results/rgb_nrgbkdes_acc_c.mat', 'acc_c', 'predictlabel', 'testlabel');
...
if instance
   ...
   save('./results/rgb_nrgbkdes_acc_i.mat', 'acc_i', 'predictlabel', 'testlabel');
