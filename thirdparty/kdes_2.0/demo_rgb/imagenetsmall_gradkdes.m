...
data_params.savedir = ['../kdesfeatures/imagenetsmall' 'gradkdes'];
...
for i = 1:trail
    ...
    imagenetsmall_acc_lsvm_gradkdes(i,1) = mean(predictlabel == testlabel');

    % print and save classification accuracy
    disp(['Accuracy of Liblinear is ' num2str(mean(imagenetsmall_acc_lsvm_gradkdes))]);
    save('./results/imagenetsmall_acc_lsvm_gradkdes.mat', 'imagenetsmall_acc_lsvm_gradkdes');
end
totaltime = toc;
