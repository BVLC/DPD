...
data_params.savedir = ['../kdesfeatures/imagenetsmall' 'nrgbkdes'];
...
for i = 1:trail
    ...
    imagenetsmall_acc_lsvm_nrgbkdes(i,1) = mean(predictlabel == testlabel');

    % print and save classification accuracy
    disp(['Accuracy of Liblinear is ' num2str(mean(imagenetsmall_acc_lsvm_nrgbkdes))]);
    save('./results/imagenetsmall_acc_lsvm_nrgbkdes.mat', 'imagenetsmall_acc_lsvm_nrgbkdes');
end
totaltime = toc;
