...
data_params.savedir = ['../kdesfeatures/imagenetsmall' 'rgbkdes'];
...
for i = 1:trail
    ...
    imagenetsmall_acc_lsvm_rgbkdes(i,1) = mean(predictlabel == testlabel');

    % print and save classification accuracy
    disp(['Accuracy of Liblinear is ' num2str(mean(imagenetsmall_acc_lsvm_rgbkdes))]);
    save('./results/imagenetsmall_acc_lsvm_rgbkdes.mat', 'imagenetsmall_acc_lsvm_rgbkdes');
end
totaltime = toc;
